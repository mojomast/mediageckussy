...
export const INTERVIEW_QUESTIONS: InterviewQuestion[] = [
  ...
  },
  {
    ...
    formatsOnly: ["tv_series", "feature_film", "web_series"],
  },
  {
    index: 5,
    phase: 2,
    fieldPath: "canon.world_setting",
    fieldType: "string",
    prompt: "What's the core setup of the show - the format, recurring segments, or frame listeners can expect each episode?",
    hint: "For example: interview show, panel discussion, fictional audio world, reported nonfiction, or recurring bit structure",
    formatsOnly: ["podcast"],
  },
  {
    index: 6,
  ...
  },
  {
    ...
    fieldPath: "canon.characters",
    fieldType: "character",
    prompt: "Who is the main host or on-mic voice we should anchor around? Name and a brief description.",
    hint: "If it is ensemble-led, give the main recurring voice first",
    formatsOnly: ["podcast"],
  },
  {
    index: 10,
  ...
  },
  {
    ...
    fieldPath: "canon.characters",
    fieldType: "character",
    prompt: "Any recurring co-hosts, guests, or supporting voices we should note?",
    hint: "Say 'done' or 'just the one' to move on",
    optional: true,
    formatsOnly: ["podcast"],
  },
  ...
  },
  {
    ...
    fieldPath: "canon.episodes",
    fieldType: "episode",
    prompt: "What's a representative first episode topic or hook? Give me a title and a one-liner.",
    hint: "This can be the pilot topic, launch episode, or a sample recurring bit",
    formatsOnly: ["podcast"],
  },
  {
    index: 12,
  ...
  },
  {
    ...
    fieldPath: "canon.episodes",
    fieldType: "episode",
    prompt: "What would a second sample episode or recurring topic be?",
    hint: "Say 'done' to move on",
    optional: true,
    formatsOnly: ["podcast"],
  },
